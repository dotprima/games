<div class="axil-post-list-area post-listview-visible-color axil-section-gap bg-color-white">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-xl-8" data-bs-spy="scroll" data-bs-target="#post" data-bs-offset="0" class="scrollspy-example" tabindex="0">
                    ...
                    <div class="axil-single-widget widget widget_categories mb--30">
                        <ul>
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="<?=ENV('APP_URL')?>assets/images/post-images/category-image-01.jpg" alt="">
                                    </div>
                                    <div class="content">
                            ...
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="<?=ENV('APP_URL')?>assets/images/post-images/category-image-02.jpg" alt="">
                                    </div>
                                    <div class="content">
                            ...
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="<?=ENV('APP_URL')?>assets/images/post-images/category-image-03.jpg" alt="">
                                    </div>
                                    <div class="content">
                            ...
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="<?=ENV('APP_URL')?>assets/images/post-images/category-image-04.jpg" alt="">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="axil-single-widget widget widget_postlist mb--30">
                        ...
                        <div class="post-medium-block">
                            ...
                            <div class="content-block post-medium mb--20">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="<?=ENV('APP_URL')?>assets/images/small-images/blog-sm-01.jpg" alt="Post Images">
                                    </a>
                                </div>
                                <div class="post-content">
                            ...
                            <div class="content-block post-medium mb--20">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="<?=ENV('APP_URL')?>assets/images/small-images/blog-sm-02.jpg" alt="Post Images">
                                    </a>
                                </div>
                                <div class="post-content">
                            ...
                            <div class="content-block post-medium mb--20">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="<?=ENV('APP_URL')?>assets/images/small-images/blog-sm-03.jpg" alt="Post Images">
                                    </a>
                                </div>
                                <div class="post-content">
                    ...
                    <div class="axil-single-widget widget widget_instagram mb--30">
                        ...
                        <ul class="instagram-post-list-wrapper">
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="<?=ENV('APP_URL')?>assets/images/small-images/instagram-01.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="<?=ENV('APP_URL')?>assets/images/small-images/instagram-02.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="<?=ENV('APP_URL')?>assets/images/small-images/instagram-03.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="<?=ENV('APP_URL')?>assets/images/small-images/instagram-04.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="<?=ENV('APP_URL')?>assets/images/small-images/instagram-05.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="<?=ENV('APP_URL')?>assets/images/small-images/instagram-06.jpg" alt="Instagram Images">
                                </a>
                            </li>
                        </ul>
                        <!-- End Post List  -->
