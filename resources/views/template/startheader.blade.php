            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-8 col-lg-4 col-md-4 col-12">
                    <div
                        ...
                        <div class="logo">
                            <a href="index-2.html">
                                <img class="dark-logo" src="<?=ENV('APP_URL')?>assets/images/logo/logo-black.png"
                                    alt="Blogar logo">
                                <img class="light-logo" src="<?=ENV('APP_URL')?>assets/images/logo/logo-white2.png"
                                    alt="Blogar logo">
                            </a>
                        </div>
                                ...
                                <ul class="mainmenu">
                                    <li class="menu-item-has-children"><a href="#">Home</a>
                                        <ul class="axil-submenu">
                                            <li>
                                                <a class="hover-flip-item-wrapper" href="index-2.html">
                                            ...
                                            <li>
                                                <a class="hover-flip-item-wrapper"
                                                    ...
                                                    <span class="hover-flip-item">
                                                        <span data-text="Home Creative Blog">Home Creative
                                                            Blog</span>
                                                    </span>
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a class="hover-flip-item-wrapper"
                                                    ...
                                                    <span class="hover-flip-item">
                                                        <span data-text="Home Lifestyle Blog">Home Lifestyle
                                                            Blog</span>
                                                    </span>
                                                </a>
                                            </li>
                                        ...
                                        <ul class="axil-submenu">
                                            ...
                                            <li>
                                                <a class="hover-flip-item-wrapper"
                                                    ...
                                                    <span class="hover-flip-item">
                                                        <span data-text="Post Format Text Only">Post Format
                                                            Text Only</span>
                                                    </span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="hover-flip-item-wrapper" href="post-layout-1.html">
                                                    <span class="hover-flip-item">
                                                        <span data-text="Post Layout One">Post Layout
                                                            One</span>
                                                    </span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="hover-flip-item-wrapper" href="post-layout-2.html">
                                                    <span class="hover-flip-item">
                                                        <span data-text="Post Layout Two">Post Layout
                                                            Two</span>
                                                    </span>
                                                </a>
                                            </li>
                                                                    ...
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100"
                                                                                    src="<?=ENV('APP_URL')?>assets/images/others/mega-post-01.jpg"
                                                                                    alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100"
                                                                                    src="<?=ENV('APP_URL')?>assets/images/others/mega-post-02.jpg"
                                                                                    alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                                        <div class="post-content">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100"
                                                                                    src="<?=ENV('APP_URL')?>assets/images/others/mega-post-03.jpg"
                                                                                    alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                                        <div class="post-content">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100"
                                                                                    src="<?=ENV('APP_URL')?>assets/images/others/mega-post-04.jpg"
                                                                                    alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                                        <div class="post-content">
                ...
                <div class="col-xl-4 col-lg-8 col-md-8 col-12">
                    <div
                        ...
                        <ul class="metabar-block">
                            ...
                            <li><a href="#"><img src="<?=ENV('APP_URL')?>assets/images/others/author.png"
