                ...
                <div class="list-categories categories-activation axil-slick-arrow arrow-between-side">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="<?=ENV('APP_URL')?>assets/images/post-images/post-sm-01.jpg"
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="<?=ENV('APP_URL')?>assets/images/post-images/post-sm-02.jpg"
                                        alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="<?=ENV('APP_URL')?>assets/images/post-images/post-sm-03.jpg"
                                        alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="<?=ENV('APP_URL')?>assets/images/post-images/post-sm-04.jpg"
                                        alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="<?=ENV('APP_URL')?>assets/images/post-images/post-sm-05.jpg"
                                        alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="<?=ENV('APP_URL')?>assets/images/post-images/post-sm-06.jpg"
                                        alt="post categories images">
                                </div>
                                <div class="content">
