<div class="popup-mobilemenu-area">
    <div class="inner">
        <div class="mobile-menu-top">
            <div class="logo">
                <a href="index-2.html">
                    <img class="dark-logo" src="<?=ENV('APP_URL')?>assets/images/logo/logo-black.png" alt="Logo Images">
                    <img class="light-logo" src="<?=ENV('APP_URL')?>assets/images/logo/logo-white2.png" alt="Logo Images">
                </a>
            </div>
